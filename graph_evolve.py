...
# Exécuter le script PHP et récupérer la sortie
result = subprocess.run(['php', 'data.php'], capture_output=True, text=True)
...
# Maintenant, data est un dictionnaire Python avec les données
print(data)
n_students=data['number_students']

nisc=data['instructor-students_co']
nssc =data['students-students_co']
timesteps=data['timesteps']
persuasion_probability=data['proba_persu']
corruption_probability=data['proba_corrupt']
